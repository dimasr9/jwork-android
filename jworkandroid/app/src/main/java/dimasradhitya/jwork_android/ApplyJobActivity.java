...
public class ApplyJobActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textCode = findViewById(R.id.apply_staticReferralCode);
        ...
        Button hitung = findViewById(R.id.btnCount);
        ...
        btnApply.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(selected.equals("Bank")){
                    applyRequest = new ApplyJobRequest(String.valueOf(jobID), String.valueOf(jobseekerID), responseListenerOrder);
                }
                else if(selected.equals("E-Wallet")){
                    applyRequest = new ApplyJobRequest(String.valueOf(jobID), String.valueOf(jobseekerID), referral_code.getText().toString(), responseListenerOrder);
                }
